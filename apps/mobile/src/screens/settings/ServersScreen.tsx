    ...
    confirmDestructive({
      ...
      message:
        profile.mode === "connect"
          ? "The app forgets this server and its device credential. The phone stays listed under Machines in your Beam Connect dashboard until you revoke it there."
  ...
  return (
    <>
      ...
      <GroupedScreen testID="servers-screen">
        {profiles.length === 0 ? (
          <SettingsSection footnote="No servers saved yet. Pair through Beam Connect or enter a direct URL.">
            <GroupedRow
              title="Add server"
              leading="Plus"
              leadingTone="primary"
          ...
          >
            {profiles.map((profile) => (
              <GroupedRow
                ...
                value={profile.mode === "connect" ? "Beam Connect" : "Direct"}
                trailing={
