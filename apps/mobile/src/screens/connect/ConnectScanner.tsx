    ...
    return (
      ...
      >
        <Text variant="bodyLarge" className="text-center">
          Beam needs the camera to scan the pairing QR code.
        </Text>
  ...
  return (
    <View className="gap-2">
      ...
      <Text variant="footnote" tone="muted" className="px-4">
        {lastIgnored
          ? `Not a Beam pairing code: ${lastIgnored}`
          : "Point the camera at the QR code from Beam Settings → Remote access → Add mobile device."}
      </Text>
    </View>
  );
}
