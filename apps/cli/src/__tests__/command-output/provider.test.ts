...
describe("beam provider command output", () => {
  setupCommandOutputTestEnvironment();

  const register: CommandRegistrar = (program) =>
    registerProviderCommands(program, () => "http://server");

  it("beam provider list renders the shared borderless table", async () => {
  ...
  it("beam provider list resolves a machine and preserves portable JSON output", async () => {
  ...
  it("beam provider models renders the shared borderless table", async () => {
  ...
  it("beam provider models includes a matching selected-only model", async () => {
    const get = vi.fn(async () => ({
      providers: [],
      models: [
        {
  ...
  it("beam provider models routes through an environment", async () => {
    const get = vi.fn(async () => ({
      providers: [],
      models: [],
      selectedOnlyModels: [],
