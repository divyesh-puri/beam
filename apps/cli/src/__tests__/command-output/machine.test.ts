...
describe("beam machine command output", () => {
  setupCommandOutputTestEnvironment();

  const register: CommandRegistrar = (program) =>
    registerMachineCommands(program, () => "http://server");

  it("beam machine list --json prints the raw host list", async () => {
  ...
  it("beam machine list renders names, IDs, status, and relative last seen", async () => {
  ...
  it("beam machine retry-update resolves the machine and requests a retry", async () => {
