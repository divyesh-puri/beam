export const GITHUB_URL = "https://github.com/divyesh-puri/beam";
...
export const SITE_TITLE = "Beam: the orchestrator that builds itself";
export const SITE_DESCRIPTION =
  "Beam can control, customize, and automate itself, laying the groundwork for your own software factory. Fully open source and local-first, with Claude Code, Codex, Cursor, Pi, OpenCode, Grok, omp, and Hermes.";
export const OG_DESCRIPTION =
  "Beam can control, customize, and automate itself, laying the groundwork for your own software factory.";
...
export function unfurlMeta(title: string, description: string, path: string) {
  return [
    ...
    { property: "og:site_name", content: "Beam" },
    ...
    { property: "og:image:height", content: "1260" },
    {
      ...
      content:
        "Beam logo — The orchestrator that builds itself. Free, open source, and local-first.",
    },
