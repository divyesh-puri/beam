  ...
  switch (plugin.status) {
    case "error":
      ...
      if (plugin.provenance === "builtin") {
        return "Reload the plugin. If it still fails, restart Beam.";
      }
    ...
    case "incompatible":
      return plugin.provenance === "builtin"
        ...
        : "Install a version compatible with this Beam instance.";
    case "missing":
      return plugin.provenance === "builtin"
...
function pluginRuntimeCondition(plugin: PluginListItem): string {
  switch (plugin.status) {
    ...
    case "incompatible":
      return "This plugin version isn't compatible with your version of Beam.";
    case "missing":
