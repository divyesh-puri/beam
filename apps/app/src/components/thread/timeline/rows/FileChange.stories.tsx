...
const baseProps = {
  ...
  workspaceRootPath: "/Users/michael/.beam-dev/worktrees/env_story/beam",
};
...
const updateApiTypes: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.beam-dev/worktrees/env_story/beam/packages/server-contract/src/api-types.ts",
    kind: "update",
    movePath: null,
...
const addFormatHelpersTest: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.beam-dev/worktrees/env_story/beam/packages/thread-view/test/format-helpers.test.ts",
    kind: "add",
    movePath: null,
...
const deleteActiveThinking: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.beam-dev/worktrees/env_story/beam/packages/core-ui/src/active-thinking.ts",
    kind: "delete",
    movePath: null,
...
const largeRefactorComposer: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.beam-dev/worktrees/env_story/beam/apps/app/src/views/ThreadFollowUpComposer.tsx",
    kind: "update",
    movePath: null,
...
const errorFileChange: TimelineRow = {
  ...
  status: "error",
  stderr:
    "ENOENT: no such file or directory, open '/Users/michael/.beam-dev/worktrees/env_story/beam/packages/server-contract/src/api-types.ts'\n",
};
