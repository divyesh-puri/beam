...
const projectClaudeSkillReadTool = createSkillReadRow({
  ...
  sequenceOffset: 0,
  skillPath:
    "/Users/brsbl/Code/beam/.claude/skills/moss-hardening-review/SKILL.md",
});
...
const projectCodexSkillReadTool = createSkillReadRow({
  ...
  sequenceOffset: 4,
  skillPath: "/Users/brsbl/Code/beam/.codex/skills/workspace-tools/SKILL.md",
});
