...
const lintCommand: TimelineRow = commandRow({
  ...
  command:
    "pnpm exec turbo run lint --filter=@bb/core-ui --filter=@bb/server --concurrency=1",
  cwd: "/Users/michael/.beam-dev/worktrees/env_33i22gvcqe/beam",
  source: null,
  output:
