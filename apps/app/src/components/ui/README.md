...
- No product data dependencies: no queries, atoms, routing, server calls, or Beam
  lifecycle concepts.
...
Use named feature folders for canonical rendering of Beam domain concepts. These
...
2. If not, is it a pure Beam domain renderer used by multiple consumers?
