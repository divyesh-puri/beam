        ...
        files: [
          {
            ...
            size: 123456789,
            url: "Beam-0.0.2-universal.zip",
          },
        ],
        minimumSystemVersion: null,
        path: "Beam-0.0.2-universal.zip",
        platform: "macos",
        releaseDate: checkedAt,
        releaseName: "Beam desktop 0.0.2",
        releaseNotes: null,
        schemaVersion: 1,
        sha512: "BASE64_SHA512_FROM_ELECTRON_BUILDER",
        ...
        files: [
          {
            sha512: "BASE64_SHA512_FROM_ELECTRON_BUILDER",
            size: 123456789,
            url: "beam-nightly-0.0.2-nightly.1.1-arm64.zip",
          },
        ],
        minimumSystemVersion: null,
        path: "beam-nightly-0.0.2-nightly.1.1-arm64.zip",
        platform: "macos",
        releaseDate: checkedAt,
        releaseName: "Beam Nightly desktop 0.0.2-nightly.1.1",
        releaseNotes: null,
        schemaVersion: 1,
        sha512: "BASE64_SHA512_FROM_ELECTRON_BUILDER",
        stagingPercentage: null,
        ...
        files: [
          {
            sha512: "BASE64_SHA512_FROM_ELECTRON_BUILDER",
            size: 123456789,
            url: "Beam-0.0.2-x86_64.AppImage",
          },
        ],
        minimumSystemVersion: null,
        path: "Beam-0.0.2-x86_64.AppImage",
        platform: "linux",
        releaseDate: checkedAt,
        releaseName: "Beam desktop 0.0.2",
        releaseNotes: null,
