...
// repo's installed shared-runtime packages. `beam plugin build` shims the
...
// The shimmed npm modules, from the same list `beam plugin build` shims
...
// installed copies.
// Consumed by
// \`beam plugin build\` to emit static ESM re-export shims over
