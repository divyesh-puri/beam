    ...
    throw new Error(
      [
        ...
        missingOrMismatchedIndexes.length > 0
          ...
          : null,
        "This usually means the local DB was created by an incompatible prelaunch migration history. Restart Beam so migrations can run; if this persists in development, back up the DB and run pnpm reset:dev.",
      ]
