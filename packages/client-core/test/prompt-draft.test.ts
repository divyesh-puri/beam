...
describe("prompt draft helpers", () => {
  ...
  it("expands automation command pills before mapping draft text to prompt input", () => {
    ...
    expect(input).toEqual([
      {
        type: "text",
        text: "Create a new Beam automation to keep checking CI",
        mentions: [],
      },
    ]);
  });
  ...
  it("keeps mention ranges correct after expanding an automation command pill", () => {
    ...
    expect(input).toEqual([
      {
        type: "text",
        text: "Create a new Beam automation to inspect @thread",
        mentions: [
          {
            start: "Create a new Beam automation to inspect ".length,
            end: "Create a new Beam automation to inspect @thread".length,
            resource: threadResource,
          },
        ],
      },
