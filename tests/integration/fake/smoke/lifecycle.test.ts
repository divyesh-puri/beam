  ...
  it("starts parent and child threads with the shared runtime config", async () => {
    ...
    try {
      await withHarness(async (harness) => {
        ...
        expect(parentRuntimeCommand.instructions).toContain("beam status");
        expect(parentRuntimeCommand.instructions).toContain("beam guide");
        expect(parentRuntimeCommand.instructions).toContain("Markdown links");
        expect(childRuntimeCommand.instructions).toContain("beam status");
        expect(childRuntimeCommand.instructions).toContain("beam guide");
