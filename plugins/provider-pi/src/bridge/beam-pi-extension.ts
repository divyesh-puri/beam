export const BEAM_PI_EXTENSION_SOURCE = String.raw`
...
// ---- JSON Schema → TypeBox (the Beam tool definitions carry JSON Schema) ----
...
export default function bbExtension(pi) {
  ...
  pi.on("session_start", async (_event, ctx) => {
    ...
    // predate the Beam tools, so make sure every injected tool is active.
