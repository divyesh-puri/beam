...
Use `beam secret request` whenever work needs a credential. Do not ask the user to paste a secret into chat.
...
```bash
beam secret request OPENAI_API_KEY RESEND_API_KEY \
