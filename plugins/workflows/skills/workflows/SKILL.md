...
A workflow puts deterministic control flow around normal Beam worker threads. The
...
beam workflows run --file .bb/workflows/review-change.js --args '{"items":[]}'
```
...
Use beam workflows status for compact progress. Redirect bounded history pages
...
- The source passes beam workflows validate.
